# -*- coding: utf-8 -*-
"""Dashboard_051_091_fixed (1).ipynb

Automatically generated by Colab.

Original file is located at
    https://colab.research.google.com/drive/1s0A7TADPRTO53JSIDZNZoCtZwtLlhAcZ
"""

# SEL 1 — Instalasi
!pip install streamlit tensorflow scikit-learn plotly openpyxl -q
!pip install pyngrok -q

# SEL 2 — Upload dataset
from google.colab import files
files.upload()   # masukkan file heart (1).xslx
...
# SEL 4 — Jalankan + buka tunnel
from  pyngrok import ngrok

# Terminate all active ngrok tunnels
ngrok.kill()

ngrok.set_auth_token("3FI9vKbcVUlKqCvN5m5hm3EoLVP_81XU72Jsug48xHefchedz")
